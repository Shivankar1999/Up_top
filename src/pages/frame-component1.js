  ...
  return (
    <>
      <div className={styles.frameParent}>
        ...
        <div className={styles.frameGroup} Herosec>
          <div className={styles.frameWrapper} navbar>
          ...
          <div className={styles.frameWrapper1} main>
        ...
        <aside className={styles.frameAside} Sidebar>
          <div className={styles.frameParent30}>
            <div className={styles.frameParent31}>
              <button className={styles.dashboardParent}>
                <img
              ...
              <div className={styles.noteAltParent}>
                <img
                  ...
                  src="/note-alt.svg"
                />
                <div className={styles.assessment1}>Assessment</div>
                <div className={styles.rectangleDiv} />
              </div>
